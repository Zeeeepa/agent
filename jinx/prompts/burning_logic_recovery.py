...
def _load() -> str:
    ...
    return (
        ...
        "- If uncertainty exists, ask a single clarifying question using <python_question_{key}> with exactly one print(...) line.\n"
        "  The printed string MUST NOT contain '<' or '>' characters; use plain text.\n"
        ...
        "- The <python_question_{key}> block must contain valid Python code only: a single print(\"...\"). No other tags or prose.\n"
