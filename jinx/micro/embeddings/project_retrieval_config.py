...
PROJ_STAGE_LINEEXACT_MS = int(os.getenv("EMBED_PROJECT_STAGE_LINEEXACT_MS", "300"))
...
PROJ_STAGE_EXACT_MS = int(os.getenv("EMBED_PROJECT_STAGE_EXACT_MS", "240"))
PROJ_STAGE_LITERAL_MS = int(os.getenv("EMBED_PROJECT_STAGE_LITERAL_MS", "380"))
