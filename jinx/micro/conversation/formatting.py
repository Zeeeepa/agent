...
def ensure_header_block_separation(text: str) -> str:
    ...
    t = re.sub(r"(</embeddings_context>)[\s\u00A0\u2007\u202F]*(<continuity_anchors>)", r"\1\n\n\2", t)
    ...
    t = re.sub(r"(</embeddings_code>)[\s\u00A0\u2007\u202F]*(<continuity_anchors>)", r"\1\n\n\2", t)
    ...
    t = re.sub(r"(</continuity_anchors>)[\s\u00A0\u2007\u202F]*(<evergreen>)", r"\1\n\n\2", t)
    t = re.sub(r"(</continuity_anchors>)[\s\u00A0\u2007\u202F]*(<memory>)", r"\1\n\n\2", t)
    t = re.sub(r"(</continuity_anchors>)[\s\u00A0\u2007\u202F]*(<task>)", r"\1\n\n\2", t)
    t = re.sub(r"(</continuity_anchors>)[\s\u00A0\u2007\u202F]*(<error>)", r"\1\n\n\2", t)
